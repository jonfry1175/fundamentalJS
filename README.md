...
4. npx sequelize-cli model:generate --name User --attributes username:string,email:string,password:string,image:string,age:integer
- untuk membuat class dan juga migrations

5. npx sequelize-cli model:generate --name Item --attributes name:string,type:string,price:integer,stock:integer,image:string,UserId:integer
- untuk membuat class dan juga migrations
